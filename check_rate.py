...
# 30cm straight section from https://arxiv.org/abs/2407.12450, 
# spacing causes 50x reduction from intrinsic (0.02 mrad) to spaced (1 mrad)
Lmuontest = 0.3*0.02 # m
...
print("Number of interactions / 1e6 muons:", intrate*1e6)
